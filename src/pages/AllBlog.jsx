    ...
    <>
      <div className="mt-14 grid grid-cols-2 gap-10">
        <div>
          <div>
            <img
              src="/public/Image/pexels-artempodrez-7773387.jpg"
              alt=""
              className="w-full hover:shadow-xl h-hlv"
            />
          </div>
          <div className="py-6">
            ...
            <Link
              to="/Blog:id"
              className="flex space-x-3 items-center mt-4 px-6 py-3 bg-orange-500 hover:bg-orange-400 w-4/12"
            >
