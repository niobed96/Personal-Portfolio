...
function Work() {
  return (
    <>
      <div className="px-32">
        <h1 className="text-3xl font-bold text-blue-900 mb-10">WORK</h1>
        <div className="w-3/5 mb-6">
          <p className="text-xl">
            Behind every project is a process built on clarality, creativity,
            and purpose. I work closely with clients to first understand their
            vision, challenges, and goals, then craft solutions that not only
            solve problemss but spark connection. here is how i do it.
          </p>
        </div>
        <div className="flex items-center space-x-4">
          <p className="font-semibold text-xl">Get In Touch</p>
          <Link to="/Contact">
            <button className="border-2 border-black border-solid px-4 py-1 rounded-3xl hover:border-orange-600 hover:bg-orange-600">
              <svg
                width="30px"
                height="30px"
                viewBox="0 -6.5 36 36"
        ...
        <div className="grid grid-cols-2 gap-16 mt-20">
          <Link to="/Work:id">
            <img
              src="Image/pexels-artempodrez-7773387.jpg"
              alt=""
            ...
            <div>
              <div className="flex space-x-2 items-center mt-3">
                ...
                <img src="Image/right_17150897.png" alt="" className="size-5" />
              </div>
              <p className="text-lg mt-2">
                A responsive e-commerce platform with dynamic product filtering,
                cart management, and a checkout flow.
              </p>
              <div className="flex space-x-5 my-6">
                <span className="bg-gray-300 rounded-2xl px-5 py-1 text-lg">
                  React
                </span>
                <span className="bg-gray-300 rounded-2xl px-5 py-1 text-lg">
                  JavaScript
          ...
          <div>
            <img
              src="Image/pexels-eren-li-7241294.jpg"
              alt=""
              className="rounded-2xl w-full h-96"
            />
            <div>
              ...
              <p className="text-lg mt-2">
                An interactive, online experience designed to simulate the
                thrill of a physical escape room in a digital environment.
              </p>
              <div className="flex space-x-5 my-6">
                <span className="bg-gray-300 rounded-2xl px-5 py-1 text-lg">
                  HTML5
