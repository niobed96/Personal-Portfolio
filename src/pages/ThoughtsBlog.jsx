    ...
    <>
      <div className="grid grid-cols-2 gap-10 mt-14">
        <div>
          <div>
            <img
              src="/public/Image/pexels-bobbydimas-30518545.jpg"
              alt=""
              className="w-full hover:shadow-xl h-hlv object-cover"
            />
          </div>
          <div className="py-6">
            <h2 className="text-xl font-semibold">
              My Journey into Front-End Development: From Zero to (Almost) Hero
            </h2>
            <p className="text-lg mt-4">
              A personal story of learning to code, overcoming obstacles, and
              finding my passion in front-end development.
            </p>
            <Link className="flex space-x-3 items-center mt-4 px-6 py-3 bg-orange-500 hover:bg-orange-400 w-4/12">
